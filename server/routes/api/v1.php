...
use App\Http\Controllers\StandardTimeSettingController;
...
// Apply 'maintenance' and 'log-http' middleware to all other API routes
Route::middleware(['maintenance', \App\Http\Middleware\LogHttpRequests::class])->group(function () {
    ...
    Route::middleware([
        ...
        Route::middleware('role:hr')->group(function () {
            ...
            // Standard Time Settings (HR only)
            Route::get('/standard-time-settings', [StandardTimeSettingController::class, 'index']);
            Route::put('/standard-time-settings', [StandardTimeSettingController::class, 'update']);
            
            // Attendance Statistics (HR only)
    ...
    Route::middleware(['auth:sanctum', 'role:hr'])->group(function () {
        ...
        Route::get('/daily-login-activity', [AuthController::class, 'getDailyLoginActivity']);
        Route::get('/positions-by-office', [AuthController::class, 'getPositionsByOffice']);
        Route::get('/module-usage', [ModuleAccessController::class, 'getModuleUsage']);
    });
